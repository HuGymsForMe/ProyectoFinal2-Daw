...
function CookiesPolicyPage() {
    ...
    useSeo({
        title: "Política de Cookies | AutoescuelaFast",
        description: "Política de Cookies de Autoescuela Fast."
    })
        ...
        <>
            ...
            <main className="text-black flex flex-col items-center min-h-screen py-8">
                <section className="flex justify-center sm:w-[75%] w-[90%] gap-6 bg-white rounded-lg p-8 flex-col md:my-auto xl:mt-32">
                    ...
                    <h2 className="font-semibold">¿Qué son las cookies?</h2>
                    ...
                    <h2 className="font-semibold">Tipos de cookies</h2>
                    <p>
                    ...
                    <ul className="flex-col gap-2 flex list-disc ml-4">
                    ...
                    <h2 className="font-semibold">Desactivación y eliminación de cookies</h2>
                    ...
                    <ul className="flex-col gap-2 flex list-disc ml-4">
                        <li>
                            Microsoft Internet Explorer o Microsoft Edge: <Link to={"http://windows.microsoft.com/eses/windows-vista/Block-or-allow-cookies"} className="text-blue-600">http://windows.microsoft.com/eses/windows-vista/Block-or-allow-cookies</Link>
                        </li>
                        <li>
                            Mozilla Firefox: <Link to={"http://support.mozilla.org/es/kb/impedir-que-los-sitios-webguarden-sus-preferencia"} className="text-blue-600">http://support.mozilla.org/es/kb/impedir-que-los-sitios-webguarden-sus-preferencia</Link>
                        </li>
                        <li>Chrome: <Link to={"https://support.google.com/accounts/answer/61416?hl=es"} className="text-blue-600">https://support.google.com/accounts/answer/61416?hl=es</Link> </li>
                        <li>Safari: <Link to={"http://safari.helpmax.net/es/privacidad-y-seguridad/como-gestionar-lascookies/"} className="text-blue-600">http://safari.helpmax.net/es/privacidad-y-seguridad/como-gestionar-lascookies/</Link></li>
                        <li>Opera: <Link to={"http://help.opera.com/Linux/10.60/es-ES/cookies.html "} className="text-blue-600">http://help.opera.com/Linux/10.60/es-ES/cookies.html </Link></li>
                    </ul>
                    <h2 className="font-semibold">Aceptación de la Política de cookies</h2>
                    <p>AutoescuelaFast asume que usted acepta el uso de cookies. No obstante, muestra
                    ...
                    <ul className="flex-col gap-2 flex list-disc ml-4">
                        ...
                        <li>
                            ...
                            cookies, conocer la Política de cookies de AutoescuelaFast y modificar la
