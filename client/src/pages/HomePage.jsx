...
function HomePage() {
    ...
    return (
        <>
            <Navbar />
            <main className="text-white py-8 gap-y-8 flex flex-col items-center">
                ...
                <section className="flex xl:flex-row flex-col w-[77%] items-center gap-6">
                    <div className="flex flex-col items-center px-4 py-8 gap-y-4 rounded-xl bg-white lg:w-[50%] w-[100%]">
                        ...
                        <p className={`text-[#C21D30] text-center`}>¡ Podrás realizar muchos test ! Además de ver en tu perfil de test, tus mejores resultados en cuanto a tiempo y fallos. Nuestro objetivo es que salgas de AutoescuelaFast con todos los test en verde y con tu exámen teórico aprobado.</p>
                    </div>
                    <div className="flex flex-col items-center px-4 py-8 gap-y-4 rounded-xl bg-white lg:w-[50%] w-[100%]">
                        ...
                        <p className={`text-[#C21D30] text-center`}>¡ Podrás ver toda tu evolución ! Cuántas veces has entrado, qué videos has visualizado, cuántos y qué tests has hecho y qué fallos has tenido para que puedas repasar. ¡ Además te damos tu probabilidad de aprobado !</p>
                    </div>
                </section>
